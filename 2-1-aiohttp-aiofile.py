#Ans
#Wed Aug  9 13:53:02 2023 - Starting...
#Wed Aug  9 13:53:03 2023 - Writing 'jazzchromia' to './asyncout/new_file0.txt'...
#Wed Aug  9 13:53:03 2023 - Writing 'louisville arabesquetech' to './asyncout/new_file2.txt'...
#Wed Aug  9 13:53:03 2023 - Writing 'new orleans panpipe-fox' to './asyncout/new_file4.txt'...
#Wed Aug  9 13:53:03 2023 - Writing 'rock gold' to './asyncout/new_file3.txt'...
#Wed Aug  9 13:53:03 2023 - Writing 'pop nashville hip hop' to './asyncout/new_file1.txt'...
#Time to complete asyncio red/writes: 1.14 seconds
...
async def main():
    ...
    print(f"Time to complete asyncio red/writes: {round (end - start, 2)} seconds")
